...
Public Class rptPendingDelivery
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Service_Software.rptPendingDelivery.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPendingDelivery
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPendingDelivery = New rptPendingDelivery()
        rpt.Site = Me.Site
        Return rpt
    End Function
