...
Public Class rptClaimSlipParts1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Service_Software.rptClaimSlipParts1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptClaimSlipParts1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptClaimSlipParts1 = New rptClaimSlipParts1()
        rpt.Site = Me.Site
        Return rpt
    End Function
