...
Public Class rptUnderProcess
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Service_Software.rptUnderProcess.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptUnderProcess
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptUnderProcess = New rptUnderProcess()
        rpt.Site = Me.Site
        Return rpt
    End Function
