...
Public Class rptEstimateRefuse
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Service_Software.rptEstimateRefuse.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEstimateRefuse
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEstimateRefuse = New rptEstimateRefuse()
        rpt.Site = Me.Site
        Return rpt
    End Function
