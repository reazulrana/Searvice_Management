...
Public Class rptDailyTransaction
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptDailyTransaction.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Service_Software.rptDailyTransaction.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDailyTransaction
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDailyTransaction = New rptDailyTransaction()
        rpt.Site = Me.Site
        Return rpt
    End Function
