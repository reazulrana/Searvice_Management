...
Public Class rptBillPayment
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Service_Software.rptBillPayment.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBillPayment
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBillPayment = New rptBillPayment()
        rpt.Site = Me.Site
        Return rpt
    End Function
