...
Public Class rptPresentStock
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Service_Software.rptPresentStock.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPresentStock
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPresentStock = New rptPresentStock()
        rpt.Site = Me.Site
        Return rpt
    End Function
