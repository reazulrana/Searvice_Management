...
Public Class rptClaimSlip
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Service_Software.rptClaimSlip.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptClaimSlip
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptClaimSlip = New rptClaimSlip()
        rpt.Site = Me.Site
        Return rpt
    End Function
