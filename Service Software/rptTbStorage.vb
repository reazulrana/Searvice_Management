...
Public Class rptTbStorage
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Service_Software.rptTbStorage.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTbStorage
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTbStorage = New rptTbStorage()
        rpt.Site = Me.Site
        Return rpt
    End Function
