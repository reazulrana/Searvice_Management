...
Public Class rptNotAssigned
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Service_Software.rptNotAssigned.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptNotAssigned
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptNotAssigned = New rptNotAssigned()
        rpt.Site = Me.Site
        Return rpt
    End Function
