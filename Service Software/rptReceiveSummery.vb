...
Public Class rptReceiveSummery
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Service_Software.rptReceiveSummery.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptReceiveSummery
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReceiveSummery = New rptReceiveSummery()
        rpt.Site = Me.Site
        Return rpt
    End Function
