...
Public Class rptBillPayment1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Service_Software.rptBillPayment1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBillPayment1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBillPayment1 = New rptBillPayment1()
        rpt.Site = Me.Site
        Return rpt
    End Function
