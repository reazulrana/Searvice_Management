...
Public Class rptClaimSlipParts
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Service_Software.rptClaimSlipParts.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptClaimSlipParts
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptClaimSlipParts = New rptClaimSlipParts()
        rpt.Site = Me.Site
        Return rpt
    End Function
